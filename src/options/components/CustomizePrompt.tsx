      ...
      {!isIOS && (
        <>
          ...
          <Collapse.Group>
            ...
            <Collapse
              title={
                <Text h4 className="nooby--mt-5 nooby--mb-0">
                  YouTube {' '}
                </Text>
              }
            >
              ...
              <Text className="nooby--my-1">Example Prompts: </Text>
              <ul className="nooby--prompt__list">
                <li>
            ...
            <Collapse
              title={
                <Text h4 className="nooby--mt-5 nooby--mb-0">
                  Comment Summary{' '}
                  <Text span font="12px" className="nooby--subtitle">
