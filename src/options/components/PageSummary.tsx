    ...
    <>
      ...
      <Card>
        <Card.Content>
          <Text
            h5
            className="nooby--mb-0 nooby--flex nooby--flex-row nooby--items-center nooby--gap-1"
          >
            <Toggle
              initialChecked
          ...
          <Text className="nooby--mt-0" font="12px">
            Once hidden, the nooby icon will no longer appear on the page. However, you can open
            the page summary by clicking on the browser extension icon.
          </Text>
        </Card.Content>
        <Divider />
        <Card.Content>
          <Text h4 className="nooby--mb-0">
            Whitelist Sites
          </Text>
          <Text className="nooby--mt-0" font="12px">
            Only display the nooby icon on these sites (one URL per line).
          </Text>
          <Spacer h={0.5} />
          <Textarea
            placeholder="https://nooby.app
https://reddit.com"
            resize={'vertical'}
        ...
        <Card.Content>
          ...
          <Text className="nooby--mt-0" font="12px">
            Do not display nooby icon on these sites (one URL per line).
          </Text>
          <Spacer h={0.5} />
          <Textarea
            placeholder="https://nooby.app
