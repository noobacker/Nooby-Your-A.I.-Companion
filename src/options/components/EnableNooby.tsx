...
function EnableNooby(props: Props) {
      ...
      {!isIOS && (
        <>
          <Text h3 className="nooby--mt-5">
            ...
            <Text font="12px" my={0}>
              You can enable/disable the nooby Summary on the following website.
            </Text>
          </Text>
          ...
          <Card>
            <Card.Content>
              <Checkbox.Group
                ...
                className="nooby--support__sites"
              >
                {Object.entries(supportSites).map(([k, v]) => {
                  return (
                    <Checkbox key={k} value={v.siteValue} className="nooby--support__sites--item">
                      {v.siteName}
                    </Checkbox>
                  )
                })}
