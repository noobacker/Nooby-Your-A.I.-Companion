...
import EnableNooby from './components/EnableNooby'
...
function OptionsPage(
  ...
  return (
    <div className="nooby--container nooby--mx-auto">
      <Header />

      <main className="nooby--w-[900px] nooby--mx-auto nooby--mt-14 nooby--options">
        <Text h2>Options</Text>

        {/* Trigger Mode */}
        {!isIOS && (
          <>
            <Text h3 className="nooby--mt-5">
              Trigger Mode
            </Text>
            <Radio.Group
              value={triggerMode}
        ...
        {/* Language */}
        <Text h3 className="nooby--mt-5 nooby--mb-0">
          Language
        </Text>
        <Text className="nooby--my-1">
          The language used in ChatGPT response. <span className="nooby--italic">Auto</span> is
          recommended.
        </Text>
        <Select
          value={language}
        ...
        {/* Misc */}
        {/* <Text h3 className="nooby--mt-8">
          Misc
        </Text>
        <div className="nooby--flex nooby--flex-row nooby--items-center nooby--gap-4">
