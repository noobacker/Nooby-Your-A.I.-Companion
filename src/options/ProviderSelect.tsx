...
const ConfigPanel: FC<ConfigProps> = ({ config, models }) => {
  ...
  return (
    <>
      <Card className="nooby--card">
        <div className="nooby--flex nooby--flex-col nooby--gap-3">
          <Radio.Group value={tab} onChange={(v) => setTab(v as ProviderType)}>
            ...
            <Radio value={ProviderType.GPT3}>
              OpenAI API
              <Radio.Desc>
                <div className="nooby--flex nooby--flex-col nooby--gap-2">
                  <span>
                    OpenAI official API, more stable,{' '}
                    <span className="nooby--font-semibold">charge by usage</span>
                  </span>
                  <div className="nooby--flex nooby--flex-row nooby--gap-2 nooby--geist--select">
                    <Input
                      htmlType="text"
                  ...
                  <span className="nooby--italic nooby--text-xs">
            ...
            <Radio value={ProviderType.ChinaGpt}>
                  ChinGpt webapp
                  <Radio.Desc>
                    {' '}
                    The API that powers Free ChinaGpt
                  </Radio.Desc>
            </Radio>
            ...
            <Radio value={ProviderType.Gemini}>
                  ...
                  <Radio.Desc>
                    {' '}
                    The Google most advance Gemini Model
                  </Radio.Desc>
            </Radio>          
