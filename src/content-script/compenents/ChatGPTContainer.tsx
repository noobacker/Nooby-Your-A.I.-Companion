      ...
      <GeistProvider themeType={themeType}>
        <>
          <div className="nooby--chatgpt">
            <div className="nooby--header">
              <div className="nooby--mymyheader">
                
                <a
                  rel="noreferrer"
                  target="_blank"
                  className="nooby--header__logo"
                >
                  <img src={logo} width={10} alt={APP_TITLE} />
                </a>
                <a
                  rel="noreferrer"
                  target="_blank"
                ...
                <a href="javascript:;" className="nooby--header__logo" onClick={openOptionsPage}>
                  <GearIcon size={14} />
                </a>

                {loading ? (
                  <span className="nooby--header__logo">
                    <Spinner className="nooby--icon--loading" />
                  </span>
                ) : (
                  <a href="javascript:;" className="nooby--header__logo" onClick={onRefresh}>
                    <SyncIcon size={14} />
                  </a>
                )}
              ...
              <div className="nooby--chatgpt__action"></div>
            </div>

            <div className="nooby--main">
              <div className="nooby--main__container">
                {questionProps.question ? (
                  <>
                    {triggerMode === TriggerMode.Manually && !questionProps.currentTime ? (
                      <span
                        className="nooby--link"
                        onClick={() => {
                          onRefresh()
                        }}
                      >
                      ...
                      <>
                        {loading && (
                          <div className="nooby--main__loading">
                            <Loading />
                          </div>
                        )}
                        <ChatGPTCard
            ...
            {questionProps.question && currentTranscript && (
              <div className="nooby--main">
                <div className="nooby--main__header">
                  <div className="nooby--main__header--title">
                    Transcript
                    {questionProps.langOptionsWithLink.length > 1 && (
                      <>
                        {' '}
                        <select
                          className="nooby--select"
                  ...
                  <div className="nooby--main__header--action">
                ...
                <div
                  className="nooby--main__container nooby--main__container--subtitle"
                  style={{
                ...
                >
                  {currentTranscript.map((v, i) => {
                    ...
                    return (
                      <div className="nooby--subtitle" key={i}>
                        <div
