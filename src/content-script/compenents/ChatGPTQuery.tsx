  ...
  if (answer) {
    return (
      <div className="markdown-body gpt-markdown" id="gpt-answer" dir="auto">
        <div className="nooby--chatgpt--header">
          <ChatGPTFeedback
        ...
        <div className="nooby--chatgpt--content" ref={wrapRef}>
        ...
        {/* {done && showTip && (
          <p className="nooby--italic nooby--mt-2">
      ...
      <p>
        {isSafari ? (
          <>
            ...
            <button
              className={classNames('nooby--btn', 'nooby--btn__primary', 'nooby--btn__small')}
        ...
        {retry > 0 &&
          ...
          (() => {
            if (isBraveBrowser()) {
              return (
                <span className="nooby--block nooby--mt-2">
              ...
              return (
                <span className="nooby--italic nooby--block nooby--mt-2 nooby--text-xs">
  ...
  if (error) {
    return (
      <p>
        ...
        <span className="nooby--break-all nooby--block">{error}</span>
        <a
