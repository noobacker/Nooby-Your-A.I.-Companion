...
export default async function mount(props: MountProps) {
  ...
  if (document.querySelector('section.nooby--container')) {
    document.querySelector('section.nooby--container')?.remove()
  }

  const container = document.createElement('section')
  container.className = 'b_nooby'
  container.classList.add('nooby--container')
  container.id = 'nooby--container'
  ...
  switch (siteName) {
    case 'pubmed': {
      container.classList.add('nooby--chatgpt--pubmed')
    ...
    case 'newspicks': {
      container.classList.add('nooby--chatgpt--newspicks')
      const appendContainer = getPossibleElementByQuerySelector(
        siteConfig.extabarContainerQuery || [],
      )
      appendContainer?.prepend(container)
    ...
    case 'yahooJpNews': {
      container.classList.add('nooby--chatgpt--yahoonews')
    ...
    case 'nikkei': {
      container.classList.add('nooby--chatgpt--nikkei')
      const appendContainer = getPossibleElementByQuerySelector(
        siteConfig.extabarContainerQuery || [],
      )
      appendContainer?.prepend(container)
    ...
    case 'github': {
      container.classList.add('nooby--chatgpt--github')
      const appendContainer = getPossibleElementByQuerySelector(
        siteConfig.extabarContainerQuery || [],
      )
      appendContainer?.prepend(container)
    ...
    case 'googlePatents': {
      ...
      waitForElm(extabarContainerQuery).then(() => {
        container.classList.add('nooby--chatgpt--googlePatents')
        const appendContainer = getPossibleElementByQuerySelector(
          siteConfig.extabarContainerQuery || [],
        )
        appendContainer?.prepend(container)
    ...
    case 'youtube': {
      container.classList.add('nooby--chatgpt--youtube')
    ...
    case 'bilibili': {
      container.classList.add('nooby--chatgpt--bilibili')
    ...
    default: {
      if (siteName === 'bing') {
        ...
        container.classList.add('nooby--chatgpt--bing')
      }
      ...
      if (siderbarContainer) {
        ...
        if (
          ...
          container.classList.add('nooby--full-container')
          const appendContainer = getPossibleElementByQuerySelector(
            siteConfig.extabarContainerQuery,
          )
          if (appendContainer) {
